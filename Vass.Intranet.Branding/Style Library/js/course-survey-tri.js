...
function checkSurvey() {
    ...
    clientContext.executeQueryAsync(
        Function.createDelegate(this, function () {
            ...
            var list = clientContext.get_web().get_lists().getByTitle('Valoración Formación Tripartita');
            var folderPath = '/es-es/formacion/lists/Valoracin Formacin Tripartita/Año ' + new Date().getFullYear() + '/' + item.get_item('Title');
...
function checkCourseFolder(year, course) {
    var yearFolder = '/es-es/formacion/lists/Valoracin Formacin Tripartita/' + year;
